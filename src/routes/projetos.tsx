...
const projects = [
  {
    ...
    text: "Desenvolvimento de rota tecnológica para síntese, em escala pré-piloto, de óxido de grafeno e derivados de carbono a partir de subprodutos têxteis. Inclui validação de funcionalidade e caracterização estrutural dos materiais obtidos.",
    bullets: [
      "Síntese pré-piloto de grafeno",
  ...
  },
  {
    ...
    text: "Usina de pirólise em escala industrial para tratamento de lodo sanitário em Arraial do Cabo (RJ), produzindo biochar enriquecido com nutrientes para recuperação de solos degradados. Projeto em parceria com UFF, FAPERJ e AEGEA.",
    bullets: [
      "Pirólise de lodo de ETE em escala industrial",
      "Biochar agregado de nutrientes",
      "Parcerias: UFF, FAPERJ e AEGEA",
    ],
  },
  {
    n: "04",
    ...
    subtitle: "Gerador híbrido multicomponentes compacto para aplicação conjunta com BESS em Data Centers Urbanos.",
    text: "Unidade de Potência Compacta (UPC) multicomponentes integrada a sistemas de armazenamento por baterias (BESS), projetada para garantir confiabilidade, descarbonização e flexibilidade energética em Data Centers urbanos.",
    bullets: [
      "Geração híbrida modular e compacta",
