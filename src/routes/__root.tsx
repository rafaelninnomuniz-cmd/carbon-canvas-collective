...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Rafael Muniz — Materiais Avançados de Carbono" },
      { property: "og:description", content: "Tecnologias disruptivas para conversão de resíduos em grafeno e carbonos precursores." },
